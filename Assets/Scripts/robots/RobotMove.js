...
public var walkSound: AudioClip;
...
function Start () {
	...
	walkSound = Resources.Load("Sounds/roboWalk") as AudioClip;
	SoundManager.instance.robots.loop = true;
	SoundManager.instance.playRobotWalk(walkSound);
}
